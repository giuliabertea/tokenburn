...
React 18 SPA served at localhost:4242 with 3 tabs (Sessions, Patterns, Templates), animated components, a design system via CSS custom properties, and fully offline bundled fonts.
