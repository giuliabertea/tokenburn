...
Express HTTP API serving the dashboard UI with 6 endpoints over SQLite data. Enables CORS for local development and opens SQLite in WAL mode for concurrent access.
